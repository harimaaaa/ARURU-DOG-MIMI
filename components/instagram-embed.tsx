    ...
    <div className="py-16 bg-cream-light">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-10">
          {/* ユーザープロフィール埋め込み - 最新の投稿が自動的に表示される */}
          <blockquote
            className="instagram-media"
            data-instgrm-captioned
            data-instgrm-permalink="https://www.instagram.com/aruru_dog_mimi/?utm_source=ig_embed&amp;utm_campaign=loading"
          ...
          >
            <div style={{ padding: "16px" }}>
              <a
                href="https://www.instagram.com/aruru_dog_mimi/?utm_source=ig_embed&amp;utm_campaign=loading"
                style={{
                  background: "#FFFFFF",
                  lineHeight: 0,
                  padding: "0 0",
